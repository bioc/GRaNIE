...
2.  Install only the required annotation packages, along with all other
    ...
    -   If you want to use the `JASPAR` 2022 database for TF and TFBS, you need the following extra packages:  `BiocManager::install(c("JASPAR2022", "TFBSTools", "motifmatchr", "rbioapi"))`
