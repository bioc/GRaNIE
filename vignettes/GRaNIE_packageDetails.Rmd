...
For user convenience, we provide an example object via a designated
helper function. This can be retrieved simply by running the following
line of code, as explained also in the R help:
...
We also provide detailed QC plots per TF that summarize the GC
background selection. For more details, see [here](#output_TF_peak_GC).
...
##### GC adjustment {#output_TF_peak_GC}

Additional diagnostic plots for the GC adjustments are currently being developed. They are available soon, stay tuned! This section will then be updated.
