...
```{r plotGeneralEnrichment, echo=TRUE, fig.cap="<i>General network enrichment for the filtered network</i>", class.output="scroll-200"}
...
```{r plotCommunityEnrichment2, echo=TRUE, fig.cap="<i>Summary of the community enrichment</i>", class.output="scroll-200"}
...
```{r TFEnrichment, echo=TRUE, fig.cap="<i>Enrichment summary for TFs</i>", class.output="scroll-200"}
