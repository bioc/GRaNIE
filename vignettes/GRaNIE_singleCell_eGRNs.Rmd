...
-   the count aggregeation method per cluster (default: `mean`, see above for important comments regarding this)
-   parameters related to `SCTransform` (`SCT_nDimensions`, default of 50)
