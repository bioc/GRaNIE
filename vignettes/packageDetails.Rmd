...
3. Metadata correlation plot (correlate all available metadata with the PCs and check fo correlation, which can help to identify potentially confounding variables that explain a large proportion of the observed variability):
